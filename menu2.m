...
%   $Revision: 5.21.4.7 $  $Date: 2010/07/02 16:16:48 $
...
textPadding = [60 60];%[22 12];   % extra [Width Height] on uicontrols to pad text
uiGap       = 14;%5;       % space between uicontrols
uiBorder    = 10;%10;       % space between edge of figure and any uicontol
winTopGap   = 50;       % gap between top of screen and top of figure **
winLeftGap  = 840;       % gap between side of screen and side of figure **
